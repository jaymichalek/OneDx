...
namespace OneDx.Models
{
    public class Patient
    {
        ...
        public Patient(int patientId, string firstName, string lastName, DateTime dateOfBirth, Gender gender, Doctor doctor, string doctorId, List<Diagnosis> diagnoses)
        {
            PatientId = patientId;
            FirstName = firstName;
            LastName = lastName;
